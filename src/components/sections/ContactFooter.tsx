  ...
  return (
    <footer id="contact" className="overflow-hidden border-t border-mist/10 px-4 pb-12 pt-16 text-center sm:px-8 sm:pb-16 sm:pt-20">
      <div className="mx-auto max-w-6xl">
        <p className="text-[10px] uppercase tracking-[0.35em] text-[#5EEAD4]">VIOLOOP · SCREEN-AWARE AI HARDWARE</p>
        ...
        <div className="mt-14 flex flex-wrap items-center justify-center gap-x-7 gap-y-3 border-t border-mist/10 pt-7">
          {channels.map(([label, href]) => <a key={label} href={href} target="_blank" rel="noreferrer" className="text-[10px] uppercase tracking-[0.2em] text-mist/35 transition hover:text-[#5EEAD4]">{label}</a>)}
        </div>
